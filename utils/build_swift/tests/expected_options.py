...
EXPECTED_DEFAULTS = {
    ...
    'build_swift_playgrounds': False,
    'build_swift_playground_macros': False,
    ...
    'install_swift_playgrounds': False,
    'install_swift_playground_macros': False,
...
EXPECTED_OPTIONS = [
    ...
    SetTrueOption('--swift-playgrounds', dest='build_swift_playgrounds'),
    SetTrueOption('--swift-playground-macros', dest='build_swift_playground_macros'),
    ...
    EnableOption('--install-swift-playgrounds', dest='install_swift_playgrounds'),
    EnableOption('--install-swift-playground-macros',
                 dest='install_swift_playground_macros'),
