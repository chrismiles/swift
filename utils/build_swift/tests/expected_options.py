...
EXPECTED_DEFAULTS = {
    ...
    'install_swift_playground': False,
...
EXPECTED_OPTIONS = [
    ...
    SetTrueOption('--swift-playground', dest='build_swift_playground'),
    ...
    EnableOption('--install-swift-playground', dest='install_swift_playground'),
